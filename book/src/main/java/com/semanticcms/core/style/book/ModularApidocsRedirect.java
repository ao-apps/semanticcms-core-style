...
package com.semanticcms.core.style.book;
...
@WebServlet("/core/style/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/core/style/apidocs/com.semanticcms.core.style/com" + Objects.toString(req.getPathInfo(), ""),
